...
const phrases = [
  'Makasi ngak tau kabar alya gimana',
  'Kangen banget ',
  'Kalo bukan karna ketulusan',
  'Enggak mungkin saya sejauh ini','Apa si alesan di balik semua ini','Kaya tujuan kita tuh apa','Rasyid ngerasa kita jalan di tempat tanpa tujuan'
...
var app = {
  ...
  chars: ['cuma temen','sumpah rasyid jahat banget','udah engak ada apa apa lagi sama dia lasing','ngak mau ngemis sedetik waktu alya lagi yah','','maaf','','sepelein aja terus','iya rasyid','ngerasa kebuang lagi','Janji ini jak enggak saya ulagin','Cuma mau waktu alya beberapaa detik aja tau','rasyid kenpa','belom move on ngapain nyari rumah baru','kan rasyid udah bosen','rasyid yg bikin gitu sendiri','ngak jadi dah','sakit,sakit banget tau','Rasyid kan ngak penting','kangen','Selagi masih bisa di salahin, salahin aja rasyid','terserah rasyid udah'],
